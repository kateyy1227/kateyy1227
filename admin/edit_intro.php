...
if (isset($_GET['id'])) {
    ...
    // ...
                ...
                $stmt = mysqli_prepare($con, "SELECT * FROM intro WHERE intro_id = ?");
...
<body>
    ...
    <form action="update_intro.php" method="post">
        <input type="hidden" name="id" value="<?php echo $intro_id; ?>">
        <label for="link">Introduction</label>
        <input type="text" name="user_name" value="<?php echo $user_name; ?>" required>
        <input type="text" name="user_intro" value="<?php echo $user_intro; ?>" required>

     <!-- Add more fields as needed -->
            <form action="system_socialmedia.php" method="post">
