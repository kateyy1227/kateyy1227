...
if (isset($_GET['id'])) {
    ...
    // ...
                ...
                $stmt = mysqli_prepare($con, "SELECT * FROM aboutme WHERE about_id = ?");
...
<body>
    ...
    <form action="update.php" method="post">
        <input type="hidden" name="id" value="<?php echo $aboutId; ?>">
        <label for="aboutTitle">About Title:</label>
        <input type="text" name="aboutTitle" value="<?php echo $aboutTitle; ?>" required>

     <!-- Add more fields as needed -->
            <form action="system_info.php" method="post">
